...
int main(){
    ...
    float pib1, area1, pib2, area2, bilhao = 1000000000;
...
float densidadepop1 = populacao1/area1, pibpercapita1 = pib1/populacao1;

float densidadepop2 = populacao2/area2, pibpercapita2 = pib2/populacao2;
